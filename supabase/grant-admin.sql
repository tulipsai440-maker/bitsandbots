...
--   Password only lets the user sign in.
...
--   1. Have the person create an account at http://localhost:8080/auth

--      (or your live Bits & Bots /auth URL) and confirm their email.
...
--   4. Verify the SELECT below shows their email with role admin.

--   5. Have them sign in and refresh any /admin page.

--

-- Ready-made file for trivarn440@gmail.com: grant-admin-trivarn440.sql
