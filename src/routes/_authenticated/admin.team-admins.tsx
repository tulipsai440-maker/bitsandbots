...
export const Route = createFileRoute("/_authenticated/admin/team-admins")({
    ...
    <AdminQuickShell>
      ...
      {!needsSetup && (
        <div className="mb-6 rounded-2xl border border-border bg-sand/50 p-5 text-sm text-muted-foreground">
          ...
          below — select <strong>Make admin</strong> to let them manage calendar, team, coaches,
          and announcements.
        </div>
      )}
...
function TeamAdminsSetupBanner({ onRetry }: { onRetry: () => void }) {
  return (
